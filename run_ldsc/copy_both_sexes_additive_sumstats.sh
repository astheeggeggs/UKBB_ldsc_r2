...
gsutil cp gs://ukbb-gwas-imputed-v3-results/export2/*.gwas.imputed_v3.both_sexes.tsv.bgz /psych/genetics_data/dpalmer/UKbb/sumstats-additive-export/both_sexes/
