...
Here we display a Uniform Manifold Approximation and Projection (UMAP) plot, projecting into two dimensions. Clicking on the various groupings of phenotypes allows you to remove that subset of points. Colouring by the final level of the `path` column can be found [here](UMAP_of_rg_final_level.html).
...
p <- div(plot_ly(x = df_merge$UMAP_rg_2d_x, y = df_merge$UMAP_rg_2d_y,
  ...
  color = ~factor(df_merge$level2cat), #size = ~carat
  hoverinfo='text',
